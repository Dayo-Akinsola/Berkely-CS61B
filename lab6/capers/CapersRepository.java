...
public class CapersRepository {
    ...
    public static void setupPersistence() throws IOException {
        ...
        final File storyFile = Utils.join(CAPERS_FOLDER, "story");
    ...
    public static void writeStory(String text) {
        final File storyFile = Utils.join(CAPERS_FOLDER, "story");
        final String stories = Utils.readContentsAsString(storyFile);
        Utils.writeContents(storyFile, stories + text + "\n");
    ...
    public static void makeDog(String name, String breed, int age) throws IOException {
        final Dog dog = new Dog(name, breed, age);
        dog.saveDog();
    ...
    public static void celebrateBirthday(String name) throws IOException {
        final Dog dog = Dog.fromFile(name);
        dog.haveBirthday();
        dog.saveDog();
    }
}
